...
public:
	...
	*/
    ...
    void postScale(const Vector3& t);
    void postTranslate(const Vector3& t);
    void postRotate(const Quaternion& q);
    void postRotate(const Quaternion& q, Matrix* dst) const;
