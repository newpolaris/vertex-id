...
void Matrix::postScale(const Vector3& t) {
    Matrix d;
    createScale(t, &d);
    // safe for self input
    multiply(d, *this, this);
}

void Matrix::postTranslate(const Vector3& t) {
    Matrix d;
    createTranslation(t, &d);
    // safe for self input
    multiply(d, *this, this);
}

void Matrix::postRotate(const Quaternion& q)
{
    postRotate(q, this);
}

void Matrix::postRotate(const Quaternion& q, Matrix* dst) const
{
    Matrix r;
    createRotation(q, &r);
    multiply(r, *this, dst);
...
void Matrix::postRotateX(float angle)
{
    Matrix r;
    createRotationX(angle, &r);
    multiply(r, *this, this);
}

void Matrix::postRotateY(float angle)
{
    Matrix r;
    createRotationY(angle, &r);
    multiply(r, *this, this);
...
void Matrix::postRotateZ(float angle)
{
    Matrix r;
    createRotationZ(angle, &r);
    multiply(r, *this, this);
